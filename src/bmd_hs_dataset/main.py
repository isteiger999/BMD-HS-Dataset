...
def main():
    ...
    for iteration in range(iterations):
        ...
        Xs_train, Xs_val, Xs_test = create_simple(split, stride_splits, device, iteration)
        train_loader, val_loader, test_loader = loaders(X_train, y_train, X_val, y_val, X_test, y_test, Xs_train, Xs_val, Xs_test)
